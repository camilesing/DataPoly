...
<!-- Reference: https://www.cnblogs.com/yangguoe/p/9406032.html -->
<script>
export default {
  name: "breadcrumb",
  data() {
  ...
  methods: {
    getBreadcrumb() {
      let matched = this.$route.matched.filter(item => item.name); // $route.matched contains all matched route records (a copy)
