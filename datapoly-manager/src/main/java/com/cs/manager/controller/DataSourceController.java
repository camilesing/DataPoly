...
public class DataSourceController {
    ...
    @Operation(summary = "查询数据源的Schema列表")
    ...
    @Operation(summary = "查询数据源在指定Schema下的所有物理表列表")
    ...
    @Operation(summary = "查询数据源在指定Schema下的所有视图表列表")
    ...
    @Operation(summary = "查询数据源指定表的列信息")
